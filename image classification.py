...
import cv2
img = cv2.imread('puppy-test2.jpg')
...
model.save(os.path.join('models', 'puppyorcatmodel.h5'))
new_model = tf.keras.models.load_model('D:\deeplearningtesting\models\puppyorcatmodel.h5')
